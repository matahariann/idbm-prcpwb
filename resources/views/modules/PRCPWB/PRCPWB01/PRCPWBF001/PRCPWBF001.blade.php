...
@section('title', 'PRCPWB - Master Data Configurations')
...
@include('modules.PRCPWB.PRCPWB01.PRCPWBF001.partials._configuration-form')
@endsection

@section('page-script')
{{ $dataTable->scripts(attributes: ['type' => 'module']) }}
@vite(['resources/js/pages/prcpwb/prcpwb01/configuration/configuration.js'])
@endsection
