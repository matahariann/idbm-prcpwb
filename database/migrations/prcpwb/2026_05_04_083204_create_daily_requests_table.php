...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->dropIfExists('PRCPWB_TRHDAILYREQUESTS');
        DB::connection($this->connection)->statement('DROP SEQUENCE IF EXISTS "SQ_TRHDAILYREQUESTS_IID"');
    }
};
