...
class FACTWMF001DataTable extends DataTable
{
    use DataTableTrait;
    ...
    {
        return 'FACTWMF001_' . date('YmdHis');
    }
    ...
    private function getActionButton($data): string
    {
        $buttons = [
            [
                'action' => 'edit',
                'service' => 'FACTWMF001-Update',
                'icon' => 'pencil',
                'class' => 'edit-configuration',
            ],
            [
                'action' => 'delete',
                'service' => 'FACTWMF001-Delete',
                'icon' => 'trash',
