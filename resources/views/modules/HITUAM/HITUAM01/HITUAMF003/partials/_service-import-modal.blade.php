<div class="modal modal-lg fade" id="service-import-modal" tabindex="-1" aria-labelledby="service-title" aria-modal="true" role="dialog">
    <div class="modal-dialog" tabindex="-1">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="service-import" enctype="multipart/form-data">
                    <div class="mb-3">
