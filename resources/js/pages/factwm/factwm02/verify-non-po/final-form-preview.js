...
import { closeSwal, showLoadingSwal } from "../../../../swallLoading";
// import Validation from "./validation";

class OCR {
    #verifyPoEndPoint = 'FACTWM/ts/verify-non-po';
            ...
            if (result.isConfirmed) {
                ...
                axios
                    ...
                    .catch(error => {
                        ...
                        // window.location.href = `/${self.#verifyPoEndPoint}`;
    ...
    #clearDraftCacheAfterSubmit() {
        sessionStorage.removeItem('verify_non_po_restore_from_final_preview');
        sessionStorage.removeItem('verify_non_po_last_draft_id');
        sessionStorage.removeItem('verify_non_po_form_snapshot');
