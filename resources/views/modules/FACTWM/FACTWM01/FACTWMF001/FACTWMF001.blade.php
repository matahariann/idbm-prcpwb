...
@section('title', 'FACTWM - Master Data Configurations')
...
@include('modules.FACTWM.FACTWM01.FACTWMF001.partials._configuration-form')
@endsection

@section('page-script')
{{ $dataTable->scripts(attributes: ['type' => 'module']) }}
@vite(['resources/js/pages/factwm/factwm01/configuration/configuration.js'])
@endsection
