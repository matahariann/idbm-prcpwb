    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar">
                    <img src="{{ asset('assets/img/initial-logo.svg') }}" alt class="rounded-circle" />
                </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a class="dropdown-item mt-0" href="{{ route('profile.show', ['user' => Auth::user()]) }}">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <small class="text-body-secondary">
                                    {{ Auth::user()->roles->pluck('VROLENAME')->toArray()[0] ?? '' }}


                                </small>
                                <br>
                                @if (Auth::user()->supplierUser)
                                    <small class="text-body-secondary">
                                        {{ Auth::user()->supplierUser->VSUPPLIER_CODE }}
                                        -
                                        {{ Auth::user()->supplierUser->VSUPPLIER_NAME }}
                                    </small>
                                @endif
                ...
                @if ($hasJetstream && Auth::check() && \Laravel\Jetstream\Jetstream::hasApiFeatures())
                    <li>
                ...
                @endif
                @if ($hasJetstream && Auth::User() && \Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    <li>
                        <div class="dropdown-divider my-1 mx-n2"></div>
                    </li>
                    <li>
