...
export default class OtherFiles {
    files = [];
    existingFiles = Array.isArray(window.APP_CONFIG?.existing_other_files)
        ? window.APP_CONFIG.existing_other_files
        : [];
    ...
    #events() {
        ...
        $(document).on('change', '#other-file-input', function () {
        ...
        // $(document).on('change', '#invoice_pdf', function () {
        //     const file = this.files[0];
        ...
        // $(document).on('change', '#tax_pdf', function () {
        //     const file = this.files[0];
    ...
    #appendFile() {
        const fileInput = $('#other-file-input')[0];
