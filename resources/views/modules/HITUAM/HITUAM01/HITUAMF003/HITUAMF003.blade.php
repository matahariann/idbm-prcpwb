...
@section('title', 'HITUAM - Master Data Service')
...
@section('content')
        ...
        <div class="card-datatable">
            <div class="d-flex justify-content-between align-items-center my-5 flex-column flex-xl-row px-6">
                <div class="d-flex align-items-center gap-2 justify-content-center flex-column flex-lg-row mt-2 mt-xxl-0">
                    ...
                    @serve('HITUAMF003-Delete')
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-danger d-flex align-items-center gap-2 py-2 px-3 d-none"
    ...
    @include('modules.HITUAM.HITUAM01.HITUAMF003.partials._service-form')
    @include('modules.HITUAM.HITUAM01.HITUAMF003.partials._service-import-modal')
    @include('modules.HITUAM.HITUAM01.HITUAMF003.partials._service-import-error')
@endsection

@section('page-script')
    {{ $dataTable->scripts(attributes: ['type' => 'module']) }}
    @vite(['resources/js/pages/hituam/hituam01/service/service.js', 'resources/js/pages/hituam/hituam01/service/service-import.js', 'resources/assets/vendor/libs/select2/select2.js'])
@endsection
