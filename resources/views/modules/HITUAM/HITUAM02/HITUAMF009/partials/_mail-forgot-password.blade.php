...
<body
    ...
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none">
        A request to reset password was received from your PixInvent Account
    </div>
    <div
        role="article"
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <p
                                                ...
                                                <span style="font-weight: 600">Astemo</span> Account
                                            </p>
                                            <p
                                                style="
                                                        font-family: 'Montserrat', sans-serif;
                                            ...
                                            <p
                                                ...
                                                hour from the time it was sent to you and can be used to change your
                                                password only once.
                                            </p>
                                            <p
                                                style="
                                                ...
                                                keeping the account, please contact us at Administrator
                                            </p>
                                            <table
                                                style="width: 100%"
                                                cellpadding="0"
