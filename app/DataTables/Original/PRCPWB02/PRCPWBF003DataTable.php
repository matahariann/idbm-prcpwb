...
class PRCPWBF003DataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<PRCPWBF003> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'prcpwbf003.action')
            ->setRowId('id');
    }
     ...
     */
    public function query(PRCPWBF003 $model): QueryBuilder
    {
