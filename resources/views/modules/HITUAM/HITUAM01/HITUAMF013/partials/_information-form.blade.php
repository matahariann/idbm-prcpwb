...
@section('title', isset($information) ? 'HITUAM - Edit Information' : 'HITUAM - Add Information')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="addInformationForm" method="POST"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('DFROM') is-invalid @enderror" id="DFROM"
                                name="DFROM"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('DTO') is-invalid @enderror" id="DTO"
                                name="DTO"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('VUSER_TYPE') is-invalid @enderror" id="VUSER_TYPE"
                                ...
                                <option value="external"
                                    {{ old('VUSER_TYPE', isset($information) ? $information->VUSER_TYPE : '') === 'external' ? 'selected' : '' }}>
                                    External
                                </option>
                            </select>
                            @error('VUSER_TYPE')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @if (isset($information) && $information->VUPDLOAD_DATA_VENDOR)
                                <small class="text-muted d-block mt-2">
                                    Current file:
                                    <a href="{{ asset('storage/' . $information->VUPDLOAD_DATA_VENDOR) }}"
                ...
                <!-- Upload Foto Asset -->
                <div class="mb-3">
                    <label class="form-label">Upload Foto Asset</label>
...
@section('page-script')
    @vite(['resources/js/pages/hituam/hituam01/information/information-form.js'])
@endsection
