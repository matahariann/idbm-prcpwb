...
@section('title', 'HITUAM - Master Role Service')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Master Role Service</li>
    </ol>
</nav>
...
@vite(['resources/js/pages/hituam/hituam01/role-service/role-service.js'])
@endsection
