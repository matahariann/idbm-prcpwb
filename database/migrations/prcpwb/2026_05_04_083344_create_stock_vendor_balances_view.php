...
return new class extends Migration
{
     ...
     * Run the migrations.
     */
    // view_sim_get_data_stockvendor_bal
    protected $connection = 'prcpwb';

    public function up(): void
    {
        DB::connection($this->connection)->statement("
            CREATE OR REPLACE VIEW VW_PRCPWB_STOCKVENDORBAL AS
            SELECT
                ...
                -- BAL: akumulasi qty belum Received dari awal bulan s.d sehari sebelum wanted_receipt_date
                (
                ...
                -- Judgment berdasarkan rasio stok
                CASE
                    WHEN COALESCE(
            ...
            LEFT JOIN \"PRCPWB_TRHDAILYREQUESTS\" dr
            ...
            WHERE st.\"DUPLOADDATE\" >= (NOW() - INTERVAL '7 days')
    ...
    {
        DB::connection($this->connection)->statement('DROP VIEW IF EXISTS VW_PRCPWB_STOCKVENDORBAL');
    }
};
